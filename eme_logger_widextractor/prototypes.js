...
emeLogger.MessageEvent = function(e) {
  ...
  switch (this.messageType) {
    case 'license-request':
      this.oemcryptoEquivalent = 'Key Request for LoadKeys';
      break;
    case 'license-renewal':
      this.oemcryptoEquivalent = 'Key Renewal Request for RefreshKey';
      break;
    default:
      this.oemcryptoEquivalent = 'none';
  } 
...
emeLogger.UpdateCall = function(args, target, result) {
  ...
  if (mks.keyStatuses === undefined || mks.keyStatuses.length == 0) {
    this.oemcryptoEquivalent = 'OEMCrypto_LoadKeys';
  } else {
    this.oemcryptoEquivalent = 'OEMCrypto_RefreshKey';
  }
